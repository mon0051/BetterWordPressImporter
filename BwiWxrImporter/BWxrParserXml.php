<?php
require_once 'WxrModel/WxrAuthor.php';
require_once 'WxrModel/WxrCategory.php';
require_once 'WxrModel/WxrComment.php';
require_once 'WxrModel/WxrPost.php';
